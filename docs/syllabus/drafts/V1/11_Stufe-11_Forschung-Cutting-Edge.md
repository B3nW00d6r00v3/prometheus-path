...
Außerdem: hier wird der **Capstone abgeschlossen** — Pitch, Demo-Video, Dokumentation für Portfolio.
...
- 🟢 **Hype-Detector** — KI-News sind voller Hype. Skepsis-Heuristiken: (1) "Revolution" mit "wird alles verändern" → meist Marketing. (2) Demo-Videos ohne Code/Reproduzierbarkeit → meist Cherry-Picked. (3) Benchmark-Wins ohne Eval-Methodik → meist gemessen am eigenen Set. (4) "Für nur X € im Monat" → kommerzielles Interesse. (5) Anonyme Threads mit hohen Versprechen → meist falsch. **Goldstandard**: gibt es Code, gibt es Production-Beispiele mit echten Nutzern, gibt es unabhängige Replikation? [Gary Marcus — Hype Critical](https://garymarcus.substack.com) (kontroverse aber notwendige Stimme)
...
- 🟢 **Branchen-Pattern statt Branchen-Inhalte** — anstatt sechs Branchen oberflächlich zu behandeln, lehrt dieses Modul ein **Vertiefungs-Pattern**, das du auf jede Branche anwenden kannst. Die Pattern-Felder pro Branche:
 ...
 5. **Datenstrategie-Spezifika** — typische Datenquellen, typische Daten-Probleme (Strukturierung, Silos, Privacy).
...
Nach Stufe 11 schließt du deinen Capstone offiziell ab. Egal welcher Track:

### Capstone-Final-Doku
- **Komplette README** im Capstone-Repo: Was, Warum, Wie, Wer, Wann, Outcome.
- **Architektur-Diagramm** der finalen Lösung.
...
- 🔧 Engineer: Faithfulness ≥0.8, Latenz P50 <3s, Cost <0.05€/Request, Eval-as-CI grün.
- 🧮 Foundations: Modell trainiert mit dokumentierten Loss-Curves, Preference Tuning durchgeführt, Eval Vorher/Nachher mit Verbesserung.
- 💼 Strategist: Vollständige Strategie-Dokumentation, funktionierender Pilot, Stakeholder-Tests mit ≥3 Nutzern, Iterations-Plan.

### Im Portfolio: `00_capstone/` als oberster Ordner mit:
- README mit Track, Use-Case, Outcomes
- Demo-Video-Link
- Pitch-Slides
- Link zum eigentlichen Capstone-Repo (falls separat)
- Reflektion zum gesamten Curriculum-Weg
...
- **Re-check geplant:** November 2026 — primär: aktuelle Newsletter/Podcasts/Blogs-Landschaft, Branchen-Tools-Updates, Capstone-Outcome-Schwellen-Kalibrierung.