# KI-Meisterlehrplan v2.1 — Komplette Master-Datei

**Version:** 2.1.0
**Datum:** Mai 2026
**Lizenz:** CC BY-SA 4.0 *(siehe `99_anhang.md` Sektion 3)*
**Format:** Konkatenation aller 19 Einzeldateien plus Inventar zu einer Master-Datei

Diese Datei ist die zusammengeführte Version des KI-Meisterlehrplans v2.1. Sie enthält alle 19 Einzeldateien plus Inventar in der curricularen Reihenfolge, getrennt durch Datei-Trenner. Verwende:

- **Diese Master-Datei** für vollständige Lese-Erfahrung an einem Stück
- **Die Einzeldateien** (`000_master.md`, `01_stufe1.md` … `99_anhang.md`) für strukturierte Navigation, individuelles Pflegen, gezielte Verweise

Bei Versionierung: Master-Datei wird mit dem regulären Versions-Schema (v2.1.x / v2.x.0 / vx.0.0) hochgezählt — siehe `99_anhang.md` Sektion 3 Versionierungs-Prozess.

**Inhaltsverzeichnis (Datei-Reihenfolge):**

0. `00_inventar_v2.0_zu_v2.1.md` — Inventar v2.0→v2.1 (Mapping)
1. `000_master.md` — Master-Datei (Track-Wahl, Outcome-Rubriken)
2. `01_stufe1.md` — Stufe 1: Onboarding
3. `02_stufe2.md` — Stufe 2: KI-Foundation
4. `03_stufe3.md` — Stufe 3: Coding-Foundation
5. `04_stufe4.md` — Stufe 4: Web-Foundations
6. `05_stufe5.md` — Stufe 5: RAG, Frameworks, MCP, Eval, UX
7. `06_stufe6.md` — Stufe 6: Agents, Multi-Agent, Vendor-SDKs, Computer Use
8. `07_stufe7.md` — Stufe 7: Deep Learning Foundations
9. `08_stufe8.md` — Stufe 8: Klassisches ML & Statistik
10. `09_stufe9.md` — Stufe 9: KI-Strategie
11. `10_stufe10.md` — Stufe 10: Spezialisierung & Production
12. `11_stufe11.md` — Stufe 11: Forschung & Cutting-Edge
13. `12_querschnitt_math.md` — Querschnitt: Math-Foundation
14. `13_querschnitt_eval.md` — Querschnitt: Eval
15. `14_querschnitt_production.md` — Querschnitt: Production & LLMOps
16. `15_capstone_a_engineer.md` — Capstone A: Engineer (🔧)
17. `16_capstone_b_foundations.md` — Capstone B: Foundations (🧮)
18. `17_capstone_c_strategist.md` — Capstone C: Strategist (💼)
19. `99_anhang.md` — Anhang (Aktualisierungslog, Mechanik, Repo-Härtung, Coursera-Audit, Glossar)
...
================================================================================
# DATEI: 00_inventar_v2.0_zu_v2.1.md
================================================================================
...
- 🟢 **Outcome-Rubrik pro Track (NEU in v2.1)** — siehe `000_master.md`. Sechs messbare Kompetenzen pro Track, plus Mid-Stage-Self-Assessments Ende Stufe 5 / 7 / 9. Vor dem Start: schau dir die Outcome-Rubrik deines Tracks an — das ist dein Ziel-Bild.
...
**Aufwand gesamt:** 🔧 38-55h · 🧮 53-75h · 💼 28-38h *(in v2.1 leicht erhöht durch Cost-Awareness-Block und Reasoning-Prompting-Block)*
**Voraussetzungen:** Stufe 1 abgeschlossen
**Last verified:** Mai 2026 · **Re-check by:** Aug 2026 (Modul 2.5 wegen volatiler Modell-Landschaft) / Nov 2026 (stabile Inhalte)
...
- **2026-05-02:** Initiale Version v2.0.0
- **Re-check geplant:** Aug 2026 für Modul 2.5 (volatile Modell-Landschaft) und Cost-Awareness-Block (Pricing-Strukturen). Nov 2026 für stabile Inhalte (Module 2.1, 2.3, 2.4, 2.6, 2.7).
...
**Aufwand gesamt:** 🔧 50-85h · 🧮 40-65h · 💼 20-40h *(in v2.1 erhöht durch Trajectory-Eval-Pflicht-Block in 6.2 und neues Modul 6.5 Computer Use)*
**Voraussetzungen:** Stufen 1-3, Stufe 4 Pflicht für 🔧, Stufe 5 (inkl. neuem Modul 5.0 Eval-Mini-Block)
**Last verified:** Mai 2026 · **Re-check by:** Aug 2026 (volatile A-Tiefe-Module 6.2, 6.5) / Nov 2026 (stabile Inhalte)

KI-Agenten sind 2026 das wichtigste Anwendungs-Pattern für komplexe Workflows. Diese Stufe baut den Agent **erst from scratch** (Pattern verstehen), dann mit modernen Frameworks (LangGraph, Agent-SDKs), dann mit Theorie-Anker (RL, MDP für 🧮), und schließlich vergleicht die Vendor-spezifischen Patterns (Claude Agent SDK, OpenAI Agents SDK, Google ADK). **Neu in v2.1:** Modul 6.5 (Computer Use & Agentic Browsing) als eigenes Sub-Modul, weil das 2026 ein zentrales Agent-Pattern ist, das in v2.0 nur als Bullet erwähnt war.

Hier wird dein Capstone-Engineer-Projekt aus Stufe 5 zum **Multi-Agent-System** erweitert. *Capstone-spezifische Anforderungen siehe `15_capstone_a_engineer.md`.*
...
- **Capstone-Engineer-Update-Block verschoben** nach `15_capstone_a_engineer.md` — die Stufen-Datei wird fokussierter.
...
- 🔧: Capstone hat Multi-Agent-Funktionalität *(Update siehe `15_capstone_a_engineer.md`)*.
...
**Bonus (🔧 für Capstone)**: Erweitere deinen Capstone-RAG aus Stufe 5 zu einem ReAct-Agent — der Agent kann jetzt deine RAG-Tools nutzen plus Web-Search. *Capstone-spezifische Anforderungen siehe `15_capstone_a_engineer.md`.*
...
- [ ] Bonus 🔧: Capstone als Agent erweitert *(siehe `15_capstone_a_engineer.md`)*
...
**Capstone-Update (🔧):** Falls dein Capstone-RAG-System aus 5.1 zum Use-Case passt, baue es zum Multi-Agent-System aus. Sonst halte das hier separat. *Capstone-spezifische Anforderungen siehe `15_capstone_a_engineer.md`.*
...
- 🔧: Capstone hat Multi-Agent-Funktionalität *(Capstone-Update siehe `15_capstone_a_engineer.md`)*
- 💼: Konzeptionelles Verständnis von Agent-Theorie und Computer-Use-Patterns
...
- **2026-05-02:** Initiale Version v2.0.0
- **Re-check geplant:** **Aug 2026 (3-Monats-Audit)** für Module 6.2, 6.5 — beide A-Tiefe-Volatil. Nov 2026 für Module 6.1, 6.3, 6.4.
...
**Wichtige Strukturänderung in v2.1:**
- **Capstone-Abschluss-Block verschoben** nach `15_capstone_a_engineer.md` als **Master-Sektion für alle drei Capstones** (Demo-Video, Pitch, Lessons-Learned, Final-Doku, Outcome-Schwellen-Check). Die Master-Sektion in Capstone-A wird von `16_capstone_b_foundations.md` und `17_capstone_c_strategist.md` referenziert. Begründung: in v2.0 stand der Abschluss-Block in Stufe 11 selbst, was die Stufe gegenüber den track-spezifischen Capstone-Dateien fragmentierte. In v2.1 kommt aller Capstone-Inhalt in die Capstone-Dateien — die Stufen-Datei bleibt fokussiert auf die zwei kontinuierlichen Module.
...
- Du hast deinen Capstone final dokumentiert, demonstriert, gepitcht. *Capstone-Abschluss-Inhalte siehe `15_capstone_a_engineer.md` Master-Sektion bzw. `16_capstone_b_foundations.md` und `17_capstone_c_strategist.md`.*
...
In v2.0 stand der Capstone-Abschluss-Block (Final-Doku, Demo-Video, Pitch, Outcome-Schwellen-Check, Portfolio-Struktur) hier in Stufe 11. In v2.1 wurde er **komplett verschoben nach `15_capstone_a_engineer.md` als Master-Sektion für alle drei Capstones**. Die Master-Sektion wird von `16_capstone_b_foundations.md` (Foundations) und `17_capstone_c_strategist.md` (Strategist) referenziert — so sind alle Capstone-Inhalte zentral in den Capstone-Dateien, nicht fragmentiert über mehrere Stufen.

**Was der Capstone-Abschluss umfasst** (Details siehe `15_capstone_a_engineer.md` Master-Sektion):
...
Bitte gehe für den Capstone-Abschluss zu `15_capstone_a_engineer.md` (für 🔧), `16_capstone_b_foundations.md` (für 🧮) bzw. `17_capstone_c_strategist.md` (für 💼).
...
- ✅ Capstone final dokumentiert, demonstriert, gepitcht *(siehe Master-Sektion in `15_capstone_a_engineer.md` und Track-spezifische Capstone-Dateien)*
...
Das Math-Diagnose-Gate ist die systematische Lösung: **vor** Stufe 7 wird gemessen, ob die Foundation steht. Wenn nicht, schließt du die Lücken — *dann* startest du Stufe 7. Erfahrungswerte aus etablierten Curricula (DLAI Specialization, Stanford CS230, fast.ai): 60-70% der Lernenden, die Backprop-Verständnis erreichen, hatten vorher solide Math-Foundation. Bei den anderen 30-40% war Math-Lücke der häufigste Abbruch-Grund.
...
- **2026-05-02:** Initiale Version v2.0.0
- **Re-check geplant:** **Aug 2026 (3-Monats-Audit als A-Tiefe-Querschnitt)** — Eval-Tools-Landschaft, neue LLM-as-Judge-Bias-Forschung, Eval-as-CI-Patterns. Plus jährlicher Hauptreview Nov 2026.



================================================================================
# DATEI: 14_querschnitt_production.md
================================================================================
...
**Production-Querschnitt-Anker im v2.1-Curriculum** (zur Orientierung):
...
- **Capstone-A (Engineer)**: Production-Hardening + Operate-Phase als Goldstandard *(NEU in v2.1)*
...
Production-Hardening ist nicht der Endpunkt — es ist die Voraussetzung für die **Operate-Phase**, die in v2.1 als Goldstandard für die Capstones definiert wird. *Details zur Operate-Phase siehe `15_capstone_a_engineer.md` Master-Sektion (auch von 17_capstone_c_strategist.md referenziert).*
...
- [ ] **Capstone-Operate-Phase durchlaufen (mindestens 4 Wochen Real-User-Betrieb)** *(NEU in v2.1, Goldstandard für Capstone-A — siehe `15_capstone_a_engineer.md`)*
...
- [ ] **Capstone-Operate-Phase mit Stakeholdern (mindestens 4 Wochen, ≥5 Nutzer/Woche)** *(NEU in v2.1, Goldstandard für Capstone-C — siehe `17_capstone_c_strategist.md`)*
...
================================================================================
# DATEI: 15_capstone_a_engineer.md
================================================================================
...
================================================================================
# DATEI: 16_capstone_b_foundations.md
================================================================================
...
================================================================================
# DATEI: 17_capstone_c_strategist.md
================================================================================

# Capstone C: Strategist (💼)

**Working Title:** KI-Strategie + Pilot für reale Organisation
**Aufwand:** 115-180h zusätzlich zu den Stufen-Aufwänden, plus 4-6 Wochen Operate-Phase
...
### Phase 5.5 — S9-Self-Assessment *(NEU in v2.1)*
...
1. **Vollständiger Aktualisierungslog** (v2.0 und v2.1 integriert)
...
- **3 Capstone-Dateien einzeln** (15/16/17) statt zusammen, mit Master-Sektion in `15_capstone_a_engineer.md` für gemeinsame Inhalte (Demo-Video, Pitch, Lessons-Learned).
...
Selbst-gepactes Curriculum für KI-Engineering, Foundations und Strategy. Drei Tracks mit klaren Tiefen-Markierungen pro Modul, 11 Stufen plus 3 Querschnitte plus 3 Capstones.
...
4. Vertiefe mit Querschnitten `12_querschnitt_math.md`, `13_querschnitt_eval.md`, `14_querschnitt_production.md` (Just-in-Time).
5. Capstone in `15_capstone_a_engineer.md`, `16_capstone_b_foundations.md`, `17_capstone_c_strategist.md`.

## Track-Aufwände (orientativ)

- 🔧 Engineer: 350-500h
- 🧮 Foundations: 500-800h
- 💼 Strategist: 350-500h
...
v2.1.0 (Mai 2026). Nächste Aktualisierung: Aug 2026 (3-Monats-Audit für A-Tiefe-Module).
```
