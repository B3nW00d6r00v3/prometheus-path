...
Stell dir vor, jedes deiner Projekte hat seinen eigenen Werkzeugkasten -- mit genau den Werkzeugen in genau der Version, die es braucht. Das ist ein Virtual Environment. Ohne es wuerdest du irgendwann erleben, dass Projekt A kaputt geht, weil du fuer Projekt B eine Library aktualisiert hast. Pflicht-Skill ab Tag 1.

## Im Detail

- **`venv`** -- Pythons eingebautes Tool fuer virtuelle Umgebungen. `python -m venv .venv` erstellt eine isolierte Python-Umgebung im Projektordner. Aktivieren, Pakete installieren, fertig.
...
| :book: | [Real Python — Virtualenv](https://realpython.com/python-virtual-environments-a-primer/) | Klassische venv-Erklaerung |

## Teste dein Verstaendnis

- [ ] Kannst du ein Virtual Environment erstellen und aktivieren?
- [ ] Weisst du, warum du nie Pakete global installieren solltest?
