...
- :white_check_mark: Solides LLM-Verständnis (Theorie + 2026-Modell-Landschaft)
- :white_check_mark: Persönliche Prompt-Library mit dokumentierten A/B-Tests
- :white_check_mark: Halluzinations- und DSGVO-Bewusstsein
- :white_check_mark: **Cost-Bewusstsein für Cloud-API-Nutzung mit aktivem Limit-Setting**
- :white_check_mark: Modell-Vergleichs-Notebook und persönlichen Wahl-Cheat-Sheet
- :white_check_mark: MCP konzeptionell verstanden (Praxis folgt in 5.3)
- :white_check_mark: **Reasoning-Modell-Anti-Patterns verstanden und einmal getestet**
- :white_check_mark: **Reasoning-Modelle als eigene Architektur-Familie verstanden, Test-Time-Compute als Skalierungs-Achse erklärbar, 200-Wörter-Reflexion zu eigenem Use-Case im Portfolio** (Block 2.5.5 — Vorlauf zu Modul 7.5)
- :white_check_mark: Mindestens ein No-Code-Workflow oder eine Web-App, die du täglich nutzt
- :wrench::abacus:: Python-CLI-Tool mit allen Best Practices
