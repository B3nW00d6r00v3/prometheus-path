...
|---|---|---|
| Stufe 5-6, 9, 10, 11 | Eval, Safety | NIST AI RMF, EU AI Act, Notion/Confluence |
...
**Phasen-Besonderheiten:**

- **Reale-Org-Pflicht** — fiktive Organisation ist nur als Notfall-Variante mit klaren Einschränkungen zugelassen.
- **Phase 1.5 Datenstrategie** — Modul 9.0 Datenreife-Assessment vor Use-Case-Auswahl.
- **Phase 3.5 Change Management** — Modul 9.6 Change-Management-Plan vor Pilot-Implementierung.
- **S9-Self-Assessment** als Pflicht-Anker am Ende der Strategie-Phase — siehe `09_stufe9.md`. 8-12-seitiger Stakeholder-Brief mit allen 9 Strategie-Disziplinen.
- **Operate-Phase mit Stakeholdern als Goldstandard** — 4-6 Wochen Real-User-Betrieb des Pilots mit mindestens 5 Nutzern pro Woche, Cost-Optimierung, Iteration, Lessons-Learned.
...
- **S9-Self-Assessment** als Brücke zwischen Strategie und Pilot
- **Stufe 10** vollendet mit Pilot-Implementation, Stakeholder-Tests und Iterations-Plan
- **Operate-Phase** in Stufe 10/11 mit echten Nutzern
...
- AI-Maturity-Bewertung der Organisation (Daten + Operating Model auf zwei Achsen)
- Operating Model gewählt mit Begründung
- Governance-Struktur mit RACI-Matrix
- **KPI-System auf 3 Ebenen**: Strategic / Operational / System KPIs
- **NIST AI RMF Map auf eigene Org angewendet**
- **ISO 42001-Bereitschafts-Bewertung**
- Talent-Roadmap (6/12/24 Monate)
- AI-Platform-Skizze
- Skalierungs-Roadmap

### Phase 3.5 — Change Management

Change Management ist eigenständige Phase, weil die häufigste Pilot-Failure-Ursache nicht Technik ist, sondern Change-Management:
...
### Phase 5.5 — Failure-Case-Risiko-Mapping
...
- ✅ Operating Model + Skalierungs-Roadmap mit **KPI-System auf 3 Ebenen** (9.3)
- ✅ Build-vs-Buy-Entscheidung (9.4)
- ✅ Compliance-Plan (9.5)
- ✅ **Change-Management-Plan mit Stakeholder-Mapping, Adoption-Curve, Betriebsrat-Plan** (9.6)
- ✅ **S9-Self-Assessment bestanden**: Stakeholder-Brief mit allen 9 Disziplinen integriert
...
### Phase 7.5 — Operate-Phase mit Stakeholdern als Goldstandard
...
|---|---|---|
| **Reale Org gewählt** | **bevorzugte Option 1-4 (siehe Reale-Org-Pflicht)** | Capstone-Repo |
| **Datenreife-Bewertung** | **5-stufiges Modell + Roadmap** | `01_5-datenstrategie.md` |
...
| **KPI-System auf 3 Ebenen** | **mindestens 15 KPIs total** | `03_operating-model.md` |
| **NIST AI RMF Map** | **alle 4 Funktionen auf eigene Org angewendet** | `03_operating-model.md` |
...
| **Change-Management-Plan** | **Stakeholder-Map, Adoption-Curve, Schulungs-Konzept, Betriebsrat-Plan** | `06-change-management.md` |
| **Phase 5.5 Failure-Case-Mapping** | **Top-3-Failure-Patterns im Stakeholder-Brief mit Mitigations-Plan** | `phase-5-5_failure-case-mapping/` |
| **S9-Self-Assessment bestanden** | **8-12-seitiger Stakeholder-Brief mit allen 9 Disziplinen** | `self-assessments/s9/` |
| Pilot | lauffähig, von ≥3 Stakeholdern getestet | Demo-Video + Test-Protokolle |
| **Operate-Phase** | **4-6 Wochen Real-User-Betrieb mit ≥5 Nutzern/Woche, alle 7 Pflicht-Aktivitäten** | Operate-Phase-Doku |
...
- `00_organisations-wahl.md` — welche Option (1-5) gewählt, Begründung
- `01_5-datenstrategie.md` — Datenreife-Bewertung, Inventar, Roadmap
...
- `self-assessments/s9/` — Stakeholder-Brief mit drei Anhängen + Reflektion
...
**Operate-Phase-Hinweis**: in der Operate-Phase mit echten Stakeholdern werden Compliance-Anforderungen real — nicht mehr nur dokumentiert, sondern gelebt. AI-Literacy-Schulung für jeden Test-Nutzer Pflicht, DSGVO-Hinweise im UI sichtbar, eventuelle Vorfälle ehrlich dokumentiert (auch wenn unangenehm).
...
- [Hans-Böckler-Stiftung — KI-Betriebsvereinbarungen](https://www.boeckler.de)
- [Prosci — Free Change Management Resources](https://www.prosci.com/resources)
